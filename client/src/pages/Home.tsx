...
function LibraryView({ name, profile, progress, quizHistory, latestSessionId, assignedStories, joinClass, joining, chooseStory }: { name: string; profile: any; progress?: { sessionsCompleted: number; averageAccuracy: number; averageWcpm: number; practiceWords: string[] }; quizHistory: any[]; latestSessionId?: string; assignedStories: Story[]; joinClass: (code: string) => void; joining: boolean; chooseStory: (story: Story) => void }) {
