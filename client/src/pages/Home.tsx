...
function LibraryView({ name, profile, progress, minutesRead, quizHistory, latestSessionId, assignedStories, joinClass, joining, chooseStory }: { name: string; profile: any; progress?: { sessionsCompleted: number; averageWcpm: number | null; readingsWithSettledPace: number; practiceWords: string[] }; minutesRead?: number; quizHistory: any[]; latestSessionId?: string; assignedStories: Story[]; joinClass: (code: string) => void; joining: boolean; chooseStory: (story: Story) => void }) {
